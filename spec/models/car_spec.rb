...
RSpec.describe Car, type: :model do
  ...
  describe 'Associations' do
    it do
      is_expected.to have_many(:ownerships).inverse_of(:car)
                                           .dependent(:destroy)
                                           .order(purchased_at: :desc)
    end
    it { is_expected.to belong_to(:owner).optional(true).class_name('Person') }
  end
  ...
  describe 'Validations' do
    ...
    it { is_expected.not_to validate_presence_of(:owner_id) }
    it do
